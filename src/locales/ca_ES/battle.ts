...
export const battle: SimpleTranslationEntries = {
  "bossAppeared": "{{bossName}} et talla el pas.",
  "trainerAppeared": "{{trainerName}}\net desafia!",
  "trainerAppearedDouble": "{{trainerName}}\net desafien!",
  "trainerSendOut": "{{trainerName}} va triar\n{{pokemonName}}!",
  "singleWildAppeared": "Un salvatge {{pokemonName}} et talla el pas!",
  "multiWildAppeared": "Un salvatge {{pokemonName1}}\ni {{pokemonName2}} et talla el pas!",
  "playerComeBack": "Torna, {{pokemonName}}!",
  "trainerComeBack": "{{trainerName}} va retirar {{pokemonName}}!",
  "playerGo": "Va! {{pokemonName}}!",
  "trainerGo": "{{trainerName}} va triar {{pokemonName}}!",
  "switchQuestion": "Vols canviar\n{{pokemonName}}?",
