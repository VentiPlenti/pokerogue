...
export const ability: AbilityTranslationEntries = {
  ...
  speedBoost: {
    name: "Accelerador",
    description: "Augmenta la seva velocitat a cada torn.",
  },
  battleArmor: {
    name: "Armadura de batalla",
    description: "Una armadura protegeix el pokémon dels cops crítics.",
  },
  sturdy: {
    name: "Ferm",
    description: "No pot ser noquejat d'un sol cop. Els moviments fulminants tampoc el poden noquejar.",
  },
  damp: {
    name: "Humit",
  ...
  static: {
    name: "Estàtic",
    description: "El Pokémon es carrega amb electricitat estàtica, podent provocar paràlisis al contacte.",
  },
  voltAbsorb: {
  ...
  oblivious: {
    name: "Inconscient",
    description: "El Pokémon és un inconscient, cosa que evita que l'enamorin o que li afectin les burles.",
  },
  cloudNine: {
    name: "Als núvols",
    description: "Elimina els efectes del clima.",
  },
  compoundEyes: {
    name: "Ulls compostos",
    description: "Els ulls compostos del Pokémon augmenten la seva precisió.",
  },
  insomnia: {
    name: "Insomni",
    description: "El Pokémon pateix d'insomni i no es pot adormir.",
  },
  colorChange: {
    name: "Canvi de color",
    description: "El tipus del Pokémon canvia segons el moviment amb el que l'ataquin.",
  },
  immunity: {
    name: "Immunitat",
    description: "El sistema immunitari del Pokémon evita que s'enverini.",
  },
  flashFire: {
    name: "Absorb Foc",
    description: "Augmenta la potència dels moviments de tipus foc del Pokémon si el colpejen amb un moviment de tipus foc.",
  },
  shieldDust: {
    name: "Escut de pols",
    description: "La pols d'aquest Pokémon bloca els efectes addicionals dels moviments que rep.",
  },
  ownTempo: {
    name: "Tempo propi",
    description: "Aquest Pokémon segueix el seu propi tempo, evitant la confusió.",
  },
  suctionCups: {
    name: "Ventoses",
  ...
  intimidate: {
    name: "Intimidació",
    description: "El Pokémon intimida els seus oponents quan entra en combat, disminuint els seus Atacs.",
  },
  shadowTag: {
    name: "Ombra fixa",
    description: "El Pokémon trepitja l'ombra del seu oponent, evitant que escapi.",
  },
  roughSkin: {
    name: "Pell rugosa",
    description: "El Pokémon provoca mal amb la seva pell rugosa a l'atacant en contacte.",
  },
  wonderGuard: {
    name: "Protecció mística",
    description: "Aquest poder misterior fa que només els moviments superefectius colpegin el Pokémon.",
  },
  levitate: {
    name: "Levitació",
    description: "Com el Pokémon levita a l'aire no l'afecten els moviments de tipus terra.",
  },
  effectSpore: {
    name: "Efecte espora",
    description: "Entrar en contacte amb aquest Pokémon pot enverinar-te, adormir-te o paralitzar-te.",
  },
  synchronize: {
    name: "Sincronització",
    description: "L'atacant rebrà el mateix efecte d'estat que provoqui en cas de cremar, enverinar o paralitzar el Pokémon.",
  },
  clearBody: {
    name: "Cos clar",
    description: "Evita que disminueixin les estadístiques del Pokémon.",
  },
  naturalCure: {
    name: "Cura natural",
    description: "Tots els efectes d'estat es curen automàticament en canviar de Pokémon.",
  },
  lightningRod: {
    name: "Parallamps",
    description: "El Pokémon atrau tots els moviments de tipus elèctric. En comptes de provocar mal, augmenten la seva estadística d'Atac Especial.",
  },
  sereneGrace: {
    name: "Gràcia serena",
    description: "Augmenta la probabilitat de provocar efectes addicionals en atacar.",
  },
  swiftSwim: {
    name: "Nadador veloç",
    description: "Augmenta la velocitat del Pokémon quan plou.",
  },
  chlorophyll: {
    name: "Clorofil·la",
    description: "Augmenta la velocitat del Pokémon quan fa sol.",
  },
  illuminate: {
    name: "Il·luminat",
    description: "Il·luminant el seu entorn, el Pokémon augmenta les probabilitats de trobar-se amb Pokémon salvatges i evita que disminueixi la seva precisió.",
  },
  trace: {
    name: "Calc",
    description: "Quan entra en combat, el Pokémon copia l'habilitat d'un dels seus oponents.",
  },
  hugePower: {
    name: "Poder immens",
    description: "Dobla l'estadística d'atac del Pokémon.",
  },
  poisonPoint: {
    name: "Punt verinós",
    description: "Entrar en contacte amb aquest Pokémon pot enverinar l'atacant.",
  },
  innerFocus: {
    name: "Força interior",
    description: "El Pokémon està concentrat, evitant els efectes de la Intimidació. A més, el Pokémon no s'estremeix.",
  },
  magmaArmor: {
    name: "Armadura de magma",
    description: "El Pokémon està recobert amb magma, evitant que el Pokémon es congeli.",
  },
  waterVeil: {
    name: "Vel d'aigua",
    description: "El Pokémon està covert amb un vel d'aigua que el protegeix de les cremades.",
  },
  magnetPull: {
    name: "Magnetisme",
    description: "Evita que els Pokémon de tipus acer escapin amb el seu magnetisme.",
  },
  soundproof: {
    name: "Insonoritzat",
    description: "L'insonorització proporciona al Pokémon immunitat a tots els moviments basats en el so.",
  },
  rainDish: {
    name: "Llepa pluja",
    description: "El Pokémon gradualment recupera salut en la pluja.",
  },
  sandStream: {
    name: "Aixeca-sorra",
    description: "El Pokémon provoca una tempesta de sorra quan entra en combat.",
  },
  pressure: {
    name: "Pressió",
    description: "Pressiona el Pokémon oponent, fent que aquest gasti més PP.",
  },
  thickFat: {
    name: "Greix gruixut",
    description: "El Pokémon està protegit per una gruixuda capa de greix, reduint a la meitat el mal que pren dels moviments de tipus foc i gel.",
  },
  earlyBird: {
    name: "Matiner",
  ...
  runAway: {
    name: "Tocar el dos",
    description: "Permet fugir sempre dels Pokémon salvatges.",
  },
  keenEye: {
    name: "Vista aguda",
    description: "Amb la seva vista aguda evita que altres Pokémon redueixin la precisió.",
  },
  hyperCutter: {
    name: "Súper urpes",
    description: "El Pokémon està orgullós de les seves poderoses urpes. Eviten que altres Pokémon disminueixin l'atac d'aquest.",
  },
  pickup: {
    name: "Recollida",
    description: "El Pokémon pot recollir l'objecte que duia un Pokémon enemic en combat.",
  },
  truant: {
    name: "Absent",
  ...
  hustle: {
    name: "Entusiasme",
    description: "Augmenta l'atac, però disminueix la precisió.",
  },
  cuteCharm: {
    name: "Cos encantador",
    description: "El contacte amb aquest Pokémon pot deixar encantat.",
  },
  plus: {
    name: "Més",
    description: "Augmenta l'atac especial del Pokémon si hi ha un aliat amb les habilitats Més o Menys en combat.",
  },
  minus: {
    name: "Menys",
    description: "Augmenta l'atac especial del Pokémon si hi ha un aliat amb les habilitats Més o Menys en combat.",
  ...
  forecast: {
    name: "Previsió",
    description: "El Pokémon es transforma amb el clima per canviar el seu tipus a aigua, foc o gel.",
  },
  stickyHold: {
    name: "Enganxós",
    description: "Els objectes que porta aquest Pokémon estan enganxats i no els pot treure un altre Pokémon.",
  },
  shedSkin: {
    name: "Muda de pell",
    description: "El Pokémon pot guarir els seus problemes d'estat mudant de pell.",
  },
  guts: {
    name: "Coratge",
    description: "El seu coratge fa que, en tenir un problema d'estat, augmenta el seu atac.",
  },
  marvelScale: {
    name: "Escata meravella",
    description: "Les meravelloses escates d'aquest Pokémon augmenten la seva defensa si pateix un problema d'estat.",
  },
  liquidOoze: {
    name: "Llim",
