...
export const ability: AbilityTranslationEntries = {
  ...
  cloudNine: {
    name: "Aclimatació",
    description: "Elimina els efectes del temps.",
  },
  compoundEyes: {
    name: "Ull Compost",
  ...
  insomnia: {
    name: "Insomni",
    description: "El Pokémon pateix insomni i no pot adormir-se.",
  },
  colorChange: {
    name: "Canvi de Color",
    description: "El tipus del Pokémon es converteix en el tipus del moviment que es fa servir contra ell.",
  },
  immunity: {
    name: "Inmunitat",
  ...
  flashFire: {
    name: "Absorb Foc",
    description: "Potencia els moviments de tipus Foc del Pokémon si és colpejat per un d'aquests.",
  },
  shieldDust: {
    name: "Pols Escut",
    description: "La pols d'aquest Pokémon bloqueja els efectes addicionals dels atacs que rep.",
  },
  ownTempo: {
    name: "Ritme Propi",
    description: "Aquest Pokémon té el seu propi ritme, i això evita que es confongui.",
  },
  suctionCups: {
    name: "Ventoses",
  ...
  intimidate: {
    name: "Intimidació",
    description: "El Pokémon intimida els Pokémon contraris en entrar a la batalla, reduint la seva estadística d'atac.",
  },
  shadowTag: {
    name: "Ombra Trampa",
    description: "Aquest Pokémon trepitja l'ombra del Pokémon contrari per evitar que s'escapi.",
  },
  roughSkin: {
    name: "Pell tosca",
    description: "Aquest Pokémon infligeix danys amb la seva pell aspre a l'atacant en fer contacte.",
  },
  wonderGuard: {
    name: "Wonder Guard",
  ...
  magmaArmor: {
    ...
    description: "El Pokémon està cobert de magma calent, la qual cosa evita que el Pokémon es congeli.",
  },
  waterVeil: {
    name: "Vel D'aigua",
    description: "El Pokémon està cobert amb un vel d'aigua, que evita que el Pokémon es cremi.",
  },
  magnetPull: {
    name: "Imant",
    description: "Impedeix que els Pokémon de tipus Steel s'escapin mitjançant la seva força magnètica.",
  },
  soundproof: {
    name: "Insonoritzar",
  ...
  pressure: {
    name: "Pressió",
    description: "En posar pressió sobre el Pokémon contrari, augmenta el seu ús de PP.",
  },
  thickFat: {
    name: "Greix",
    description: "El Pokémon està protegit per una capa de greix espessa, que redueix els danys dels moviments de tipus Foc i Gel.",
  },
  earlyBird: {
    name: "Matinar",
    description: "El Pokémon es desperta del son el doble de ràpid que altres Pokémon.",
  },
  flameBody: {
    name: "Cos de Flama",
  ...
  runAway: {
    name: "Fuga",
    description: "Permet una escapada segura dels Pokémon salvatges.",
  },
  keenEye: {
    name: "Vista Aguda",
    description: "Els ulls aguts impedeixen que altres Pokémon redueixin la precisió d'aquest Pokémon.",
  },
  hyperCutter: {
    name: "Tall Fort",
  ...
  pickup: {
    name: "Recollir",
    description: "El Pokémon té la capacitat de recollir l'objecte que portava un oponent durant la batalla.",
  },
  truant: {
    name: "Absent",
  ...
  forecast: {
    name: "Previsió",
    description: "El Pokémon es transforma amb el temps per canviar el seu tipus a Aigua, Foc o Gel.",
  },
  stickyHold: {
    name: "Viscositat",
    description: "Els objectes que té el Pokémon s'enganxen ràpidament i no poden ser eliminats per altres Pokémon.",
  },
  shedSkin: {
    name: "Mudar",
    description: "El Pokémon pot curar les seves pròpies condicions d'estat eliminant la seva pell.",
  },
  guts: {
    name: "Coratge",
